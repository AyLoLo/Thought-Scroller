...
Revision ID: 94e2b996cc9f
Revises: 
Create Date: 2023-09-06 19:16:41.245831
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('posted_by_user', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(), nullable=False),
    sa.Column('content', sa.String(), nullable=False),
    sa.Column('vote_count', sa.Integer(), nullable=True),
    sa.Column('comment_count', sa.Integer(), nullable=True),
    sa.Column('date_created', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['posted_by_user'], ['users.username'], name=op.f('fk_posts_posted_by_user_users')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['post_id'], ['posts.id'], name=op.f('fk_postvote_post_id_posts')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_postvote_user_id_users')),
    sa.PrimaryKeyConstraint('id')
    )
